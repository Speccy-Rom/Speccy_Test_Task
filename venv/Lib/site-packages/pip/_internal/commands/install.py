        ...
        try:
            ...
            if pep517_build_failure_names := [
                ...
                raise InstallationError(
                    f'Could not build wheels for {", ".join(pep517_build_failure_names)} which use PEP 517 and cannot be installed directly'
                )
...
def reject_location_related_install_options(requirements, options):
    ...
    def format_options(option_names):
        ...
        return [f'--{name.replace("_", "-")}' for name in option_names]
